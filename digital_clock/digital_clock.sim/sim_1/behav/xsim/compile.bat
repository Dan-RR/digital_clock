...
REM
REM Generated by Vivado on Sun Jun 22 23:13:35 -0700 2025
...
echo "xvlog --incr --relax -L uvm -prj digital_clock_tb_vlog.prj"
call xvlog  --incr --relax -L uvm -prj digital_clock_tb_vlog.prj -log xvlog.log
